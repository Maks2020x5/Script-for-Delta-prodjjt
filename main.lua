                ...
                if (myHrp.Position - hrp.Position).Magnitude <= getgenv().aimbotMaxDist then
                    ...
                    elseif getgenv().aimbotPartMode == "Closest" then
                        ...
                        if head and torso then
                            ...
                            targetPart = ((Vector2.new(headPos.X, headPos.Y) - mousePos).Magnitude < (Vector2.new(torsoPos.X, torsoPos.Y) - mousePos).Magnitude) and head or torso
...
local activeObjects = {}
local function clearRightPanel() for _, obj in pairs(activeObjects) do obj:Destroy() end activeObjects = {} end
